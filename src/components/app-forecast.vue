      ...
      <div class="highlights-wrapper">
          ...
          <div class="card">
            ...
            <div class="card-info">
              <div class="card-justify">
                <div class="info-main">
                  <div class="info-main-num">{{ highlights?.wind?.speed }}</div>
                  <div class="info-main-text">m/s</div>
                </div>
                <div class="info-main">
                  <div class="info-main-num">{{ highlights?.wind?.deg }}</div>
            ...
            <div class="card-small-info">
              <div class="card-small-data">
                <div class="info-main-num">
                  {{ highlights?.wind?.gust || highlights?.wind?.speed }}
                </div>
                <div class="info-main-text">m/s</div>
              </div>
        ...
        <div class="highlight">
          ...
          <div class="card-small">
            ...
            <div class="card-small-info">
              <div class="card-small-data">
                <div class="info-main-num">{{ Math.round(highlights.main?.feels_like) }}</div>
        ...
        <div class="highlight">
            ...
            <div class="card-info">
              <div class="states">
                <div class="state">
                  ...
                  <div class="state-time">{{ date(highlights?.sys?.sunrise) }}</div>
                </div>
                <div class="state">
                  <div class="state-pic state-pic--flipped"></div>
                  <div class="state-title">Sunset</div>
                  <div class="state-time">{{ date(highlights?.sys?.sunset) }}</div>
                </div>
              </div>
            </div>
          </div>
          <div class="card-small">
            ...
            <div class="card-small-info">
              <div class="card-small-data">
                <div class="info-main-num">{{ highlights?.clouds?.all }}</div>
...
const { highlights } = defineProps({ highlights: Object })

const pressure = computed(() => {
  return Math.round(+highlights?.main?.pressure * 0.75)
})

const date = (time) => {
  const newTime = time * 1000 + +highlights.timezone
